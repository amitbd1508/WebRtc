...
import com.blackflag.webrtc.adapters.HistoryAdapter;
...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mHistoryAdapter = new HistoryAdapter(getApplicationContext(), new ArrayList<HistoryItem>(), this.mPubNub);
